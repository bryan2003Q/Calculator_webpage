...
function CharacterCard({ character, onMoreInfo }) {
    ...
    return (
        <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full group">
            ...
            <div className="flex justify-end mt-auto">
                <Button
                    className="py-2.5 px-5 rounded-xl text-xs sm:text-sm"
